...
[Sapkota, Rumakanta, and Mogens Nicolaisen. "An improved high throughput sequencing method for studying oomycete communities." Journal of microbiological methods 110 (2015): 33-39.](www.sciencedirect.com/science/artaicle/pii/S0167701215000275)

Attempted to optimize PCR conditions for a nested PCR using ITS6 and ITS4 followed ITS6 and ITS7 by increasing annealing temperature to 59C.
Sequenced using a 454 Junior.
Tested new protocol on three communities:

* soil samples fron Denamrk
* infected carrot tissue
* mock community of pythium and phytophthora

They got a high proportion of oomycete reads in all communities.
~6% of carrot lesion sequencing returned carrot sequences.

![sapkota](images/sapkota.jpg)


# downy mildew

Obligate plant pathogens in Peronosporaceae, typically plasmopara and peronospora. 
Prefer cool humid conditions.
Generally appears in leafs as blue-white fuzz on the underside of leaves; the top of leaves are often yellow.

![symptoms](images/downy_mildew.jpg)
![sporangia](images/downy_mildew_sporangia.jpg)
![cycle](images/downy_mildew_cycle.jpg)


# Choi 2015

[Choi, Young‐Joon, et al. "Towards a universal barcode of oomycetes–a comparison of the cox1 and cox2 loci." Molecular ecology resources (2015).](http://onlinelibrary.wiley.com/doi/10.1111/1755-0998.12398/full)

Compared the value cox1 and cox2, and the cox2-1 spacer for barcoding of oomycetes.
Cultures and herbarium specimens were amplified with newly developed primers and sequenced.
Cox2 showed the greatest potential with ~95% correct identification rate.

![barcode gap](images/choi_2015_gap.jpg)

# Springtails

The taxon Collembola in Hexapoda of uncertian evolutionary origin.
They are primarily small microbivores, fungivores and detritivores.
They are ubuiqitous in moist conditions and can occure in large numbers in microsites.
The snowflea is a springtail. 

![springtail](images/springtail.jpg)
![springtail](images/springtail_leaf.jpg)
![springtail](images/springtail_snow.jpg)
![springtail](images/springtail_water.jpg)